      ...
      <section id="cursos" className="container mx-auto px-4 py-20">
        ...
        {loadingCourses ? (
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="bg-white rounded-2xl shadow-lg overflow-hidden border-2 border-gray-100 animate-pulse">
                ...
                {[...Array(2)].map((_, setIndex) => (
                  <div key={setIndex} className="flex gap-16 items-center">
                    {companyLogos.map((company, index) => (
                      ...
                      >
                        <div className="w-56 h-32 bg-white rounded-xl border-2 border-gray-200 hover:border-blue-300 hover:shadow-lg transition-all flex items-center justify-center p-4">
                          {company.logo ? (
                            <img 
                              src={company.logo} 
                              alt={company.name}
      ...
      <section className="container mx-auto px-4 py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Estamos aquí para ayudarte. Comunícate con nosotros</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <div className="space-y-4">
                  {config?.companyEmail && (
                    <div className="flex items-start gap-4">
                      ...
                      >
                        <svg className="w-6 h-6" style={{ color: config?.primaryColor || '#3B82F6' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
                      </div>
                      <div>
                        <p className="text-sm font-semibold text-gray-900 mb-1">Email</p>
                        <a href={`mailto:${config.companyEmail}`} className="text-gray-600 hover:text-gray-900 transition-colors">
                          {config.companyEmail}
                        </a>
                      </div>
                    </div>
                  ...
                  {config?.companyPhone && (
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a href={`tel:${config.companyPhone}`} className="text-gray-600 hover:text-gray-900 transition-colors">
                          {config.companyPhone}
                        </a>
                      </div>
                    </div>
                  ...
                  {config?.companyAddress && (
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">{config.companyAddress}</p>
                      </div>
                    </div>
                  )}
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-green-500 hover:bg-green-600 text-white rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl"
                  >
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-6 py-4 text-white rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl"
                style={{ backgroundColor: config?.primaryColor || '#3B82F6' }}
              >
